...
SCHEMAS = {
    "etd.orders-value": {
        ...
        "doc": "Client orders as submitted. One row per order event.",
        "fields": [
            {"name": "order_id", "type": "string"},
            {"name": "account", "type": "string"},
            {"name": "contract", "type": "string"},
            {"name": "quantity", "type": "long"},
            {"name": "submitted_at", "type": TS},
        ],
    },
    "etd.orders-key": {
    ...
    "etd.executions-value": {
        ...
        "fields": [
            ...
            {"name": "side", "type": {"type": "enum", "name": "Side",
                                       "symbols": ["BUY", "SELL"]}},
            {"name": "exec_qty", "type": DEC},
            {"name": "exec_price", "type": DEC},
            {"name": "contract", "type": "string"},
    ...
    "emir.trade-reports-value": {
        ...
        "fields": [
            ...
            {"name": "counterparty_lei", "type": "string"},
